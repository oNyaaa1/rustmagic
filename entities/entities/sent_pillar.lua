...
ENT.Type = "anim"
ENT.Base = "base_anim"
ENT.PrintName = "Pillar"
ENT.Category = ""
ENT.Spawnable = true
ENT.AdminOnly = false
ENT.Models = "models/galaxy/rust/wood_pillar.mdl"
if SERVER then
	function ENT:Initialize()
		self.Entity:SetModel("models/galaxy/rust/wood_pillar.mdl")
		...
		self.Ent_Health = 12000
		self.Ent_HealthMax = 12000
