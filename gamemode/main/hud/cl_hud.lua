...
local function RUSTHud(text, icon, x, y, anim, col)
   ...
   surface.DrawRect(w * 0.82 + x, h * 0.862 + y, math.Clamp(anim, 0, w * 0.82 + x), h * 0.0300)
   x = x or 0
   y = y or 0
...
hook.Add("HUDPaint", "RUSTHud", function()
   ...
   RUSTHud(hp, health, w * 0.04, h * 0.009, 205 * hp / 100, Color(135, 179, 60))
   RUSTHud(thirst, water, w * 0.04, h * 0.05, 205 * (thirst / 100), Color(69, 150, 205))
   RUSTHud(hunger, food, w * 0.04, h * 0.09, 205 * (hunger / 100), Color(192, 109, 51))
   RUSTHud(charge, magic, w * 0.04, -h * 0.03, 205 * (charge / 100), Color(204, 204, 255, 100))
end)
